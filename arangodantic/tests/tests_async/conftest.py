...
class Identity(AsyncDocumentModel):
...
class SecondaryRelationGraph(AsyncGraph):
    class ArangodanticConfig:
        edge_definitions = [
            AsyncEdgeDefinition(
